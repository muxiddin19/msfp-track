...
% Title information
\title[MSFP-Track]{\textbf{MSFP-Track}: Multi-Scale Feature Pyramid with\\Adaptive Thresholds for Real-Time MOT}
\subtitle{ECCV 2026}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.42\textwidth}
            \begin{tikzpicture}[scale=0.8]
                ...
                \legend{Motion-only, Separate ReID, LITE, \textbf{MSFP-Track}}
                \end{axis}
            \end{tikzpicture}
        \end{column}
    \end{columns}
    ...
    \begin{center}
        \begin{tikzpicture}
            \node[draw, rounded corners, fill=accentorange!20, text width=10cm, align=center, inner sep=10pt] {
                \textbf{MSFP-Track:} Multi-scale fusion + Adaptive thresholds\\
...
%==============================================================================
\section{MSFP-Track Method}
%==============================================================================

\begin{frame}{MSFP-Track Architecture Overview}
    \begin{center}
        \begin{tikzpicture}[
...
\begin{frame}{Main Results: MOT17 Test Set}
    ...
    \begin{tabular}{lcccccc}
        ...
        \midrule
        \multicolumn{7}{l}{\textit{Baseline (single-layer extraction)}} \\
        LITE~\cite{lite} & 61.1 & 60.8 & 61.5 & 73.2 & 1876 & 28.3 \\
        \multicolumn{7}{l}{\textit{Ours}} \\
        MSFP (attention) & 62.8 & 62.5 & 63.1 & 75.2 & 1598 & 26.5 \\
        \rowcolor{green!20}
        \textbf{MSFP-Track} & \textbf{63.2} & \textbf{63.0} & \textbf{63.4} & \textbf{75.8} & \textbf{1512} & 26.1 \\
        \bottomrule
    \end{tabular}
    }
    \end{center}
    ...
    \begin{center}
        \begin{tikzpicture}
            \node[draw, rounded corners, fill=accentgreen!20, inner sep=8pt] {
                \textbf{MSFP-Track:} +2.1 HOTA over LITE, +6.9 over BoTSORT, \textbf{5$\times$ faster than StrongSORT}
            };
        \end{tikzpicture}
    \end{center}
\end{frame}
...
\begin{frame}{Main Results: MOT20 Test Set (Crowded)}
    ...
    \begin{tabular}{lcccccc}
        ...
        \midrule
        LITE~\cite{lite} & 52.8 & 51.5 & 54.2 & 64.5 & 2156 & 18.5 \\
        MSFP (attention) & 54.1 & 53.2 & 55.0 & 66.2 & 1978 & 17.2 \\
        \rowcolor{green!20}
        \textbf{MSFP-Track} & \textbf{54.8} & \textbf{54.0} & \textbf{55.6} & \textbf{67.1} & \textbf{1845} & 16.8 \\
        \bottomrule
    \end{tabular}
    }
    \end{center}
    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \begin{tikzpicture}[scale=0.85]
                ...
                \node[font=\scriptsize, orange] at (axis cs:26.1,64.5) {\textbf{MSFP-Track}};
                \end{axis}
            \end{tikzpicture}
        \end{column}
        \begin{column}{0.42\textwidth}
...
\begin{frame}{Conclusion}
    \begin{block}{Summary}
        \textbf{MSFP-Track} extends single-layer extraction methods with multi-scale fusion and adaptive thresholds for improved real-time MOT
    \end{block}
